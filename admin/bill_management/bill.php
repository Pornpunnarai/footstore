        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row pull-right" style="padding-bottom: 1%;padding-right: 1%">
                    <div class="col-md-12">
                        <form action="../bill_management/add_billv2.php" method="post">
                            <input type="hidden" name="activity_id" value="<?=$activity_id?>"><br>
                            <input class="btn btn-success" type="submit" value="Create Bill2">
                        </form>
                    </div>
                </div>
                <div class="row pull-right" style="padding-bottom: 1%;padding-right: 1%">
                    <div class="col-md-12">
                        <form action="../bill_management/add_bill.php" method="post">
                            <input type="hidden" name="activity_id" value="<?=$activity_id?>"><br>
                            <input class="btn btn-success" type="submit" value="Create Bill">
                        </form>
                    </div>
                </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    if(isset($activity_id)) {
                        ...
                        $sql = "SELECT * FROM `bill` WHERE activity_id = '$activity_id'";
                        $objQuery = mysqli_query($objCon, $sql);
//                        $result = mysqli_fetch_array($objQuery, MYSQLI_ASSOC);
//                        $objQuery = mysqli_query($objCon, $sql);
