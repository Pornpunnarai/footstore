    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row pull-right" style="padding-bottom: 1%;padding-right: 1%">
                    <div class="col-md-12">
                        <form action="../activity_management/add_more_files.php" method="post">
                            <input type="hidden" name="activity_id" value="<?=$activity_id?>"><br>
                            <input class="btn btn-info" type="submit" value="Add More Files">
                        </form>
                    </div>
                </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    if(isset($activity_id)) {
                        ...
                        $sql = "SELECT * FROM `activity_file` WHERE activity_id = '$activity_id'";
                        $objQuery = mysqli_query($objCon, $sql);
                        $result = mysqli_fetch_array($objQuery, MYSQLI_ASSOC);
                        $objQuery = mysqli_query($objCon, $sql);
